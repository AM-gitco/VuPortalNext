...
import { insertUserSchema, type InsertUser } from "@/lib/db/schema";
                  ...
                  <div className="mt-2">
                    <div className="flex space-x-1">
                      {[1, 2, 3, 4].map((level) => (
                        <div
                          key={level}
                          className={`h-1 w-1/4 rounded ${level <= passwordStrength ? strengthColors[passwordStrength] : "bg-gray-200"
                            }`}
                        />
                      ))}
                    </div>

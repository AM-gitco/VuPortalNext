  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-foreground">About VU Student Portal</h1>
        ...
        <Badge variant="outline" className="bg-primary/5 text-primary border-primary/20 text-lg px-4 py-2">

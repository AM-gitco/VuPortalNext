          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {earnedBadges.map((badge) => (
              <Card key={badge.id} className="border-2 border-yellow-200 bg-yellow-50 dark:bg-yellow-900/20">
                ...
                <CardContent>
                  <p className="text-foreground/80 dark:text-gray-300">{badge.description}</p>
                  <p className="text-sm text-muted-foreground mt-2">{badge.requirement}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          {availableBadges.map((badge) => (
            <Card key={badge.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="space-y-3">
                <p className="text-muted-foreground dark:text-gray-300">{badge.description}</p>
                <p className="text-sm text-muted-foreground/80">{badge.requirement}</p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="text-center p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">Upload and share study materials</p>
            </div>
            <div className="text-center p-4 border rounded-lg">
              <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-2">
                <MessageSquare className="h-6 w-6 text-green-600" />
              </div>
              <h3 className="font-semibold text-foreground">Communicator</h3>
              <p className="text-sm text-muted-foreground">Start discussions and help others</p>
            </div>
            <div className="text-center p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">Provide helpful solutions</p>
            </div>
            <div className="text-center p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">Build strong community connections</p>
            </div>
          </div>
        </CardContent>
      </Card>

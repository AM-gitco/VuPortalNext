...
import type { Solution } from "@/lib/db/schema";
...
export function Solutions({ user }: { user: any }) {
  ...
  const { data: mySolutions = [] } = useQuery<Solution[]>({
    ...
    queryFn: queryFunctions.mySolutions,
  });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground" data-testid="text-solutions-title">Assignment & GDB Solutions</h1>
